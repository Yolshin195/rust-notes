Вот список тем, которые нужно изучить, чтобы полностью понимать приведённый код на Rust, с ссылками 🐾 на официальную документацию (на английском языке, как в реальной практике Rust-разработки):
